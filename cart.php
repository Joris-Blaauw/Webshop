...
if (empty($_SESSION["ShoppingCartItems"])) { // If Shopping Cart Empty, Say So.
    ...
    foreach ($_SESSION["ShoppingCartItems"] as $Item) {
        $DeleteButton = "<span class='CartItemButtons'><form method='POST'><input type='hidden' value='$Item[Id]' name='DecrementAmount'><input class='CartItemDecrementSubmitButton' type='submit' value='-'></form><form method='POST'><input type='hidden' value='$Item[Id]' name='DeleteItemId'><input class='CartItemDeleteSubmitButton' type='submit' value='X'></form><form method='POST'><input type='hidden' value='$Item[Id]' name='IncrementAmount'><input class='CartItemIncrementSubmitButton' type='submit' value='+'></form></span>";
